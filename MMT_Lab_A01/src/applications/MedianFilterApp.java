...
public class MedianFilterApp {

	public MedianFilterApp() {
		// TODO Auto-generated constructor stub
	}

	/**
	 * @param args
	 * Execution: MedianFilterApp <SOURCEPATH> <rastersize>
	 */
	public static void main(String[] args) {
		...
		if (args.length>0){
			...
			MMTImage imgOut = MedianFilter.process(imgIn,rasterSize);
			String outputFileName = args[0].split("\\.")[0]+"_MeFil_Raster"+ rasterSize+"."+args[0].split("\\.")[1];
			FileImageWriter.write(imgOut, outputFileName);
			System.out.println("Medianfilter for file "+outputFileName + "successful");
